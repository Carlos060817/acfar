            ...
            <form action="" method="post" style="margin-bottom: 60px">
                <div class="form-row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="number" id="cnpj" placeholder="Digite o Cnpj caso for empresa não obrigatorio"
                               name="usuario['cnpj]"
                               class="form-control">
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" id="endereco" placeholder="Digite o endereço do usuario"
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" id="telefone" placeholder="Digite o telefone do usuario"
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="usuario['tipo']" required>
                            <option value="0">Acfar</option>
                    ...
                    <div class="col-md-6 form-group">
                        <label for="empresa">Responsavel pelo cadastro :</label>
