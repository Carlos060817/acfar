...
<div class="container">
    <header>
        ...
        <div style="margin-top: 60px">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <h1 class="display-4"><i class="fas fa-users-cog text-primary" aria-hidden="true"></i>
                        Usuarios
                    </h1>
                </div>

                <div class="col-sm-6 text-right">
                    <a href="usuarioacfar.php" class="btn btn-outline-primary"><i class="fas fa-plus"></i> Novo Usuário</a>
    ...
    <table class="table table-hover table-striped" id="usuariosAcfar" style="margin-bottom: 60px">
